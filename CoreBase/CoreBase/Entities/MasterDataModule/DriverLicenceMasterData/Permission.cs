...
namespace TuevSued.V1.IT.CoreBase.Entities.MasterDataModule.DriverLicenceMasterData
{
    ...
    /// 
    /// </summary>
	public class Permission : IHasId<int>, ICommonSystemFields, ISystemFields, IRemovable, IHasTitle
	{
        /// <summary>
        /// Table name
        /// </summary>
        public static readonly string EntityTableName = "MASTER_DATA_PERMISSION";
        #region Fields
        /// <summary>
        /// Columns names
        /// </summary>
