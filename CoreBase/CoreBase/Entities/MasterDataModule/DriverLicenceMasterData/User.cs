...
namespace TuevSued.V1.IT.CoreBase.Entities.MasterDataModule.DriverLicenceMasterData
{
    ...
    /// 
    /// </summary>
    public class User : IHasId<int>, ICommonSystemFields, ISystemFields, IRemovable
	{
        /// <summary>
        /// Table name
        /// </summary>
        public static readonly string EntityTableName = "MASTER_DATA_USER";
        #region Fields
        /// <summary>
        /// Columns names
        /// </summary>
        public static class Fields
        {
            ...
            /// 
            /// </summary>
            public static readonly string RoleId = "MASTER_DATA_ROLE_ID";
            /// <summary>
            /// 
            /// </summary>
