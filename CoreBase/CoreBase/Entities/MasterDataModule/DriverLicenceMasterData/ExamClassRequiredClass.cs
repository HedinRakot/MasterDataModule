...
{
    /// <summary>
    /// Entity from table DRL_EXAM_CLASS_REQUIRED_CLASS_RSP. EN: 5.2.12.8 Assignment Types for Classes (Required Class)  DE: 5.2.12.8 Fahrerlaubnis - Zuordnungsarten fuer Klassen  
    /// </summary>
    public partial  class ExamClassRequiredClass: IHasId<int>, ICommonSystemFields, ISystemFields, IRemovable
    {
        ...
        /// Table name
        /// </summary>
        public static readonly string EntityTableName = "DRL_EXAM_CLASS_REQUIRED_CLASS_RSP";
        #region Fields
        /// <summary>
        /// Columns names
        /// </summary>
        ...
        public ExamClassRequiredClass ShallowCopy()
    	{
    	   return new ExamClassRequiredClass {
                                           ...
                                           ExamClassIdRequired = this.ExamClassIdRequired,
    	                              };
    	}
    }
}
