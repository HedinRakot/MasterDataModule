...
{
    // MASTER_DATA_SITE_CHECK_RESULTS
    internal partial class MasterDataSiteCheckResultsConfiguration : EntityTypeConfiguration<MasterDataSiteCheckResults>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public MasterDataSiteCheckResultsConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".MASTER_DATA_SITE_CHECK_RESULTS");
            HasKey(x => x.Id);
