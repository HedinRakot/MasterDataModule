...
{
    // SITE_INFOS_WITH_LAST_RESULT
    internal partial class SiteInfosWithLastResultConfiguration : EntityTypeConfiguration<SiteInfosWithLastResult>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public SiteInfosWithLastResultConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".SITE_INFOS_WITH_LAST_RESULT");
