...
{
    // GET_SITES_STATUS
    internal partial class GetSitesStatusConfiguration : EntityTypeConfiguration<GetSitesStatus>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public GetSitesStatusConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".GET_SITES_STATUS");
            HasKey(x => new { x.Id, x.Name, x.SitePath, x.CreateDate, x.ChangeDate });
