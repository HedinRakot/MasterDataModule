...
{
    // GET_JOBS_STATUS
    internal partial class GetJobsStatusConfiguration : EntityTypeConfiguration<GetJobsStatus>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public GetJobsStatusConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".GET_JOBS_STATUS");
            HasKey(x => new { x.Id, x.Name, x.JobName, x.CreateDate, x.ChangeDate });
