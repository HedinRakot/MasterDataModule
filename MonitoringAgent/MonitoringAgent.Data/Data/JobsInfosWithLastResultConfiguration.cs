...
{
    // JOBS_INFOS_WITH_LAST_RESULT
    internal partial class JobsInfosWithLastResultConfiguration : EntityTypeConfiguration<JobsInfosWithLastResult>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public JobsInfosWithLastResultConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".JOBS_INFOS_WITH_LAST_RESULT");
