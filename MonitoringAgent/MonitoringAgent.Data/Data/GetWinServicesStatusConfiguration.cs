...
{
    // GET_WIN_SERVICES_STATUS
    internal partial class GetWinServicesStatusConfiguration : EntityTypeConfiguration<GetWinServicesStatus>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public GetWinServicesStatusConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".GET_WIN_SERVICES_STATUS");
            HasKey(x => new { x.Id, x.Name, x.MachineName, x.CreateDate, x.ChangeDate });
