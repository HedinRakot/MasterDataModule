...
{
    // WCF_INFOS_WITH_LAST_RESULT
    internal partial class WcfInfosWithLastResultConfiguration : EntityTypeConfiguration<WcfInfosWithLastResult>
    {
        [GeneratedCodeAttribute("EF.Reverse.POCO.Generator", "1.0.0.0")]
        public WcfInfosWithLastResultConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".WCF_INFOS_WITH_LAST_RESULT");
