	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'InsPfpInspectionTypePfpPositionRsps': _.partial(BaseRouter.showView, baseRouter, 'l!t!TechnicalInspectionMasterData/InsPfpInspectionTypePfpPositionRsps'),
	            'InsPfpInspectionTypePfpPositionRsps/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!TechnicalInspectionMasterData/AddInsPfpInspectionTypePfpPositionRsp', 'models/TechnicalInspectionMasterData/InsPfpInspectionTypePfpPositionRsp', false),
	            'InsPfpInspectionTypePfpPositionRsps/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!TechnicalInspectionMasterData/AddInsPfpInspectionTypePfpPositionRsp', 'models/TechnicalInspectionMasterData/InsPfpInspectionTypePfpPositionRsp', false),
