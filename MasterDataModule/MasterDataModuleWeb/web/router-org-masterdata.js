	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'OrgCostCenterResponsibleEmployeeRsps': _.partial(BaseRouter.showView, baseRouter, 'l!t!CommonMasterData/Org/OrgCostCenterResponsibleEmployeeRsps'),
	            'OrgCostCenterResponsibleEmployeeRsps/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!CommonMasterData/Org/AddOrgCostCenterResponsibleEmployeeRsp', 'models/CommonMasterData/Org/OrgCostCenterResponsibleEmployeeRsp', false),
	            'OrgCostCenterResponsibleEmployeeRsps/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!CommonMasterData/Org/AddOrgCostCenterResponsibleEmployeeRsp', 'models/CommonMasterData/Org/OrgCostCenterResponsibleEmployeeRsp', false),
