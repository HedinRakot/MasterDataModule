	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'MasterDataNotifications': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/MasterDataNotifications', false),
	            'MasterDataNotifications/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddMasterDataNotifications', 'models/Settings/MasterDataNotifications', false),
	            'MasterDataNotifications/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddMasterDataNotifications', 'models/Settings/MasterDataNotifications', false),
				'MasterDataMonitorableInfoMasterDataNotificationsRsps': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/MasterDataMonitorableInfoMasterDataNotificationsRsps', false),
	            'MasterDataMonitorableInfoMasterDataNotificationsRsps/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddMasterDataMonitorableInfoMasterDataNotificationsRsp', 'models/Settings/MasterDataMonitorableInfoMasterDataNotificationsRsp', false),
	            'MasterDataMonitorableInfoMasterDataNotificationsRsps/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddMasterDataMonitorableInfoMasterDataNotificationsRsp', 'models/Settings/MasterDataMonitorableInfoMasterDataNotificationsRsp', false),
