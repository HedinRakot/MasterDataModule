	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'GetApplicationLogs': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/GetApplicationLogs', false),
	            'GetApplicationLogs/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetApplicationLogs', 'models/Settings/GetApplicationLogs', false),
	            'GetApplicationLogs/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetApplicationLogs', 'models/Settings/GetApplicationLogs', false),
				...
				'GetWinServicesStatuses': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/GetWinServicesStatuses', false),
	            'GetWinServicesStatuses/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetWinServicesStatus', 'models/Settings/GetWinServicesStatus', false),
	            'GetWinServicesStatuses/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetWinServicesStatus', 'models/Settings/GetWinServicesStatus', false),
				'GetSitesStatuses': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/GetSitesStatuses', false),
	            'GetSitesStatuses/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetSitesStatus', 'models/Settings/GetSitesStatus', false),
	            'GetSitesStatuses/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetSitesStatus', 'models/Settings/GetSitesStatus', false),
				'GetJobsStatuses': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/GetJobsStatuses', false),
	            'GetJobsStatuses/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetJobsStatus', 'models/Settings/GetJobsStatus', false),
	            'GetJobsStatuses/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetJobsStatus', 'models/Settings/GetJobsStatus', false),
				'GetWcfServicesStatuses': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/GetWcfServicesStatuses', false),
	            'GetWcfServicesStatuses/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetWcfServicesStatus', 'models/Settings/GetWcfServicesStatus', false),
	            'GetWcfServicesStatuses/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddGetWcfServicesStatus', 'models/Settings/GetWcfServicesStatus', false),
			}
