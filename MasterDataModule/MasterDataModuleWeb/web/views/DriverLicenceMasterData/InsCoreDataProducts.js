define([
    ...
    'l!t!DriverLicenceMasterData/FilterInsCoreDataProduct'
    ...
    view = BaseView.extend({
		...
		columns: function () {
		    return [
		        { field: 'productName', title: this.resources.name, width: '270px' },
		        { field: 'productDescription', title: this.resources.description },
