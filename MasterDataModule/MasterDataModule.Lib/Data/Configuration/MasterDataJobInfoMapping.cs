    ...
    internal sealed class MasterDataJobInfoMapping: EntityTypeConfiguration<MasterDataJobInfo>
    {
        ...
        private MasterDataJobInfoMapping()
        {
            ...
            Property(t => t.FromDate)
                .HasColumnName(MasterDataJobInfo.Fields.FromDate)
                .IsRequired();

            Property(t => t.ToDate)
                .HasColumnName(MasterDataJobInfo.Fields.ToDate)
                .IsRequired();

            Property(t => t.LogTypeInfoId)
                .HasColumnName(MasterDataJobInfo.Fields.LogTypeInfoId);


            //Relationships
            HasOptional(m => m.LogTypeInfo)
                .WithMany(l => l.MasterDataJobInfos)
