...
namespace TuevSued.V1.IT.FE.MasterDataModule.Lib.Managers.Common
{
    ...
    /// 
    /// </summary>
    public class InsCoreDataProductManager : EntityManager<InsCoreDataProduct, int>, IInsCoreDataProductManager
	{
        public InsCoreDataProductManager(IASProEntities context) :
            base(context)
        {
        }
	}
