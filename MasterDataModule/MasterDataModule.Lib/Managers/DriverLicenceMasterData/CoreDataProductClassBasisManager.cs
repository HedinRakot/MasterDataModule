...
namespace TuevSued.V1.IT.FE.MasterDataModule.Lib.Managers.DriverLicenceMasterData
{
    ...
    /// 
    /// </summary>
    public class CoreDataProductClassBasisManager : EntityManager<CoreDataProductClassBasis, int>, ICoreDataProductClassBasisManager
	{
        public CoreDataProductClassBasisManager(IFeEntities context) :
            base(context)
        {
        }
	}
