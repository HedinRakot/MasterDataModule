...
namespace TuevSued.V1.IT.FE.MasterDataModule.Lib.Managers.DriverLicenceMasterData
{
    ...
    /// 
    /// </summary>
    public class CoreDataProductLocalizationManager : EntityManager<CoreDataProductLocalization, int>, ICoreDataProductLocalizationManager
	{
        public CoreDataProductLocalizationManager(IFeEntities context) :
            base(context)
        {
        }
	}
