...
namespace MasterDataModule.API.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsCoreDataProductGroupModel: BaseModel
    {
        ...
        /// <summary>
        ///     Model property for <see cref="InsCoreDataProductGroup.FromDate"/> entity
        /// </summary>
        [Required]
        [DataMember]
        public DateTime fromDate{ get; set; }
        /// <summary>
        ///     Model property for <see cref="InsCoreDataProductGroup.ToDate"/> entity
        /// </summary>
        [Required]
        [DataMember]
