...
INSERT INTO [dbo].[MASTER_DATA_PERMISSION]
( SYSTEM_NAME, NAME, CREATE_DATE, CHANGE_DATE, FROM_DATE, TO_DATE
)
VALUES('SettingsData', 'LogTypeInfo', GetDate(), GetDate(), '2015.04.10', '2070.12.31')
