...
IF EXISTS (SELECT OBJECT_ID FROM sys.tables where [name] = N'MASTER_DATA_ROLE_PERMISSION')
  DROP TABLE [MASTER_DATA_ROLE_PERMISSION];
...
UPDATE dbo.SYS_TABLES SET DELETE_DATE = NULL;
UPDATE dbo.SYS_COLUMNS SET DELETE_DATE = NULL;