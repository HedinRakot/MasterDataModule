...
IF OBJECT_ID(N'[dbo].[MASTER_DATA_WINDOWS_SERVICE_CHECK_RESULTS]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MASTER_DATA_WINDOWS_SERVICE_CHECK_RESULTS];
GO
IF OBJECT_ID(N'[dbo].[MASTER_DATA_WINDOWS_SERVICE_INFO]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MASTER_DATA_WINDOWS_SERVICE_INFO];
GO
...
CREATE TABLE [dbo].[MASTER_DATA_WINDOWS_SERVICE_INFO](
    [ID] int IDENTITY(1,1) NOT NULL,
    [NAME] nvarchar(max)  NOT NULL,
    [MACHINE_NAME] nvarchar(max)  NOT NULL,
    [SERVICE_NAME] nvarchar(max)  NOT NULL,
    [TIMEOUT_CHECKING] int  NOT NULL,
    [CREATE_DATE] [datetime2](2) NOT NULL DEFAULT(GETDATE()),
    [DELETE_DATE] [datetime2](2) NULL,
    [CHANGE_DATE] [datetime2](2) NOT NULL DEFAULT(GETDATE())  ,
    CONSTRAINT PK_MASTER_DATA_WINDOWS_SERVICE_INFO PRIMARY KEY CLUSTERED ([ID])
);
GO

-- Creating table 'MASTER_DATA_SITE_CHECK_RESULTS'
CREATE TABLE [dbo].[MASTER_DATA_WINDOWS_SERVICE_CHECK_RESULTS] (
    [ID] int IDENTITY(1,1) NOT NULL,
    [CHECK_STATUS] int  NULL,
    [CHECK_DATE] datetime  NULL,
    [MESSAGE] nvarchar(max)  NULL,
    [ATTEMPT] int  NULL,
    [MASTER_DATA_WINDOWS_SERVICE_INFO_ID] int  NOT NULL,
    [CREATE_DATE] [datetime2](2) NOT NULL DEFAULT(GETDATE()),
    [DELETE_DATE] [datetime2](2) NULL,
    [CHANGE_DATE] [datetime2](2) NOT NULL DEFAULT(GETDATE()),
    CONSTRAINT PK_MASTER_DATA_WINDOWS_SERVICE_CHECK_RESULTS PRIMARY KEY CLUSTERED ([ID]),
    CONSTRAINT FK_MASTER_DATA_WINDOWS_SERVICE_CHECK_RESULTS_MASTER_DATA_WINDOWS_SERVICE_INFO FOREIGN KEY ([MASTER_DATA_WINDOWS_SERVICE_INFO_ID]) 
    REFERENCES [dbo].[MASTER_DATA_WINDOWS_SERVICE_INFO] ([ID])
);
GO
-- --------------------------------------------------
